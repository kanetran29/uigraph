...
Your app generates its own behavioral map. Tests, docs, and agents are views over it. These docs describe v1: the framework-agnostic IR, the adapter contract, the pure ops, and the end-to-end slice (core, React + Angular adapters, MCP server, CLI, dashboard).
...
6. [50-validation-ladder.md](./50-validation-ladder.md) — the rungs from golden fixtures to sample-app validation to the real refapp.example frontend.
