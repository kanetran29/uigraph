...
const en: Dict = {
  ...
  'panel.verify': 'Next to verify',
  'panel.changes': 'Changes since last map',
  'panel.proposals': 'Proposals',
  'panel.steps': 'Plan path',
  'panel.inspector': 'Inspector',
  'sidebar.studio': 'Editing, scenarios & e2e suite generation live in uigraph studio.',
...
const fi: Dict = {
  ...
  'panel.verify': 'Seuraavaksi vahvistettavat',
  ...
  'sidebar.studio': 'Muokkaus, skenaariot ja e2e-testisarjojen generointi ovat uigraph studiossa.',
...
const vi: Dict = {
  ...
  'panel.verify': 'Xác minh tiếp theo',
  ...
  'sidebar.studio': 'Chỉnh sửa, kịch bản và tạo bộ e2e nằm trong uigraph studio.',
...
const zh: Dict = {
  ...
  'panel.steps': '规划路径',
  'panel.inspector': '检查器',
  'sidebar.studio': '编辑、场景与 e2e 测试套件生成功能位于 uigraph studio。',
  'settings.title': '设置',
  'settings.theme': '主题',
...
const de: Dict = {
  ...
  'panel.verify': 'Als Nächstes prüfen',
  ...
  'sidebar.studio': 'Bearbeitung, Szenarien & E2E-Suite-Generierung gibt es in uigraph studio.',
